...
class videoRead(caffe.Layer):
  ...
  def initialize(self):
    ...
    self.video_list = test_video_list
  ...
  def setup(self, bottom, top):
    ...
    for ix, line in enumerate(f_lines):
      ...
      #print "frames[0].rsplit('.', 2)[0]={}".format(frames[0].rsplit('.', 2)[0])
      video_dict[video]['frames'] = frames[0].rsplit('.', 2)[0] + '.%06d.jpg'
...
class videoReadTrain_flow(videoRead):
  ...
  def initialize(self):
    ...
    self.video_list = train_video_list
